  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Buy tested used marine and boat engines. Yamaha, Mercury, Suzuki, Volvo Penta. Outboard, inboard & sterndrive. Free shipping, warranty. Call 866-420-8266."
        canonical="/marine"
        jsonLd={{
