  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Buy tested, low-mileage used car engines and transmissions. Ford, Honda, Toyota, BMW & more. Free nationwide shipping, warranty included. Call 866-420-8266."
        canonical="/cars"
        jsonLd={{
